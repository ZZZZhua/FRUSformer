...
class MixVisionTransformer(nn.Module):
    def __init__(self, in_chans=3, num_classes=1000, embed_dims=[32, 64, 160, 256],
        ...
        self.depths         = depths
        self.channel1 = ChannelAttention(embed_dims[0])
        self.channel2 = ChannelAttention(embed_dims[1])
        self.channel3 = ChannelAttention(embed_dims[2])
        self.channel4 = ChannelAttention(embed_dims[3])
        #----------------------------------#
